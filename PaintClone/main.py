...
class PaintGUI:
    def __init__(self):
        ...
        self.cnv.pack()
        self.cnv.bind("<B!-Motion>", self.paint)
        ...
        self.bplus_btn.grid(row=1, column=1, sticky=W+E)

        self.bminus_btn = Button(self.btn_frame, text="B-", command=self.brush_minus)
        self.bminus_btn.grid(row=1, column=1, sticky=W+E)

        self.color_btn = Button(self.btn_frame, text="Chaneg Color", command=self.change_color)
